...
<head>
    ...
    <link rel="stylesheet" href="CSS/viewLikedposts.css">
...
//Query the posts that this user has liked
$sql = "SELECT * FROM `Post Likes` WHERE Account_ID = '" . $_SESSION['id'] . "'";
...
if ($result->num_rows > 0) 
{
    ...
    {
        //Query the posts that this user has liked
        $sql = "SELECT * FROM Post WHERE Post_ID = '" . $row["Post_ID"] . "'";
            ...
            while($row2 = $result2->fetch_assoc()) 
            {
                ...
                if ($result3->num_rows > 0) 
                {
                    while($row3 = $result3->fetch_assoc()) 
                    {
                        ...
                        //Print username 
                        echo "<p>Username<br>".$row3["Username"]."</p>";
                        echo "<p>Caption<br> " . $row2["Description"] . "</p>";
                        echo "<p>Image<br></p> ";
